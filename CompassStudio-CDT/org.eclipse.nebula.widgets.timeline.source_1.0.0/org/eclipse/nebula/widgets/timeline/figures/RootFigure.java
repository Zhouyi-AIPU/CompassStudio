...
public class RootFigure extends Figure implements IStyledFigure {
	...
	public TimeBaseConverter fTimeViewDetails;

	public ITimelineStyleProvider fStyleProvider;
	...
	public ResourceManager fResourceManager;

	public DetailFigure fDetailFigure;

	public OverviewFigure fOverviewFigure;
	...
	public RootFigure(ResourceManager resourceManager) {
		...
		// layout1.setVerticalSpacing(300);
		...
		// fTimeViewDetails.setScreenWidth(1);
		// fTimeViewDetails.setScaleFactor((fTimeViewDetails.fDetailScreenWidth / 0.095) / 15180, false);
	}

	public RootFigure(ResourceManager resourceManager, String path, MenuItem gmi, MenuItem delmi) {
		fResourceManager = resourceManager;
		setStyleProvider(null);
		...
		fDetailFigure = new DetailFigure(getStyleProvider(), path, gmi, delmi);
		add(fDetailFigure, BorderLayout.CENTER);
	...
	public EventFigure createEventFigure(LaneFigure parent, ITimelineEvent event) {
		...
		// parent.setToolTip(new EventTooltip(event.getTitle()));
