...
public class ASTStringUtil {
	...
	public static String[] getParameterSignatureArray(IASTFunctionDeclarator functionDeclarator) {
		if (functionDeclarator instanceof IASTStandardFunctionDeclarator) {
			...
			for (int i = 0; i < names.length; i++) {
				if (names[i] != null) {
					final IASTDeclarator declaratorForParameterName = knrDeclarator
	...
	private static StringBuilder appendDeclaratorString(StringBuilder buffer, IASTDeclarator declarator,
		...
		if (declarator != returnTypeOf) {
			...
			if (nestedDeclarator != null) {
				protectPointers = protectPointers || declarator instanceof IASTArrayDeclarator
						|| declarator instanceof IASTFunctionDeclarator || declarator instanceof IASTFieldDeclarator;
	...
	private static StringBuilder appendInitializerString(StringBuilder buffer, IASTInitializer initializer) {
		if (initializer instanceof IASTEqualsInitializer) {
			...
			buffer.append(Keywords.cpRBRACE);
				...
				|| initializer instanceof ICPPASTDesignatedInitializer) {
	...
	private static StringBuilder appendDeclSpecifierString(StringBuilder buffer, IASTDeclSpecifier declSpecifier) {
		...
		if (declSpecifier instanceof IASTCompositeTypeSpecifier) {
			...
			case IASTSimpleDeclSpecifier.t_int:
				...
				break;
			case IASTSimpleDeclSpecifier.t_half:
				buffer.append(Keywords.HALF).append(' ');
				break;
			case IASTSimpleDeclSpecifier.t_event_t:// CUSTOMIZATION FOR OPENCL
				buffer.append(Keywords.EVENT_T).append(' ');
				break;
	...
	private static StringBuilder appendTemplateParameterString(StringBuilder buffer,
			ICPPASTTemplateParameter parameter) {
