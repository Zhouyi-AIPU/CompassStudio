...
public class ChartComposite extends Composite implements ChartChangeListener, ChartProgressListener, PaintListener,
	...
	public void doSaveAs() throws IOException {
		...
		if (filename != null) {
			...
			ChartUtils.saveChartAsPNG(new File(filename), this.chart, this.canvas.getSize().x, this.canvas.getSize().y);
		}
	}
	 ...
	 *
	 * @param flag {@code true} enables trace lines for the mouse pointer on the
	 *             horizontal axis.
	 */
