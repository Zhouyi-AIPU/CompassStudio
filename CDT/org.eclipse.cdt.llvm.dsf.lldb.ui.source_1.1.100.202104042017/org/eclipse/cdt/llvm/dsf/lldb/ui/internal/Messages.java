...
public class Messages extends NLS {
	...
	// CUSTOMIZATION
	public static String NPUDebugOnHardwareWithNetwork_tip;
	public static String NPUDebugOnHardwareWithNoNetwork_tip;
	public static String NPUDebugOnHardware_Ip_port_tip;
