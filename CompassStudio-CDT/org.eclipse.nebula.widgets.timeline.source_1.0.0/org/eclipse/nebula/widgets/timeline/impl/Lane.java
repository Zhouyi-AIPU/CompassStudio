...
public class Lane extends Colored implements ILane {
	/**
	 * The cached value of the '{@link #getTimeEvents() <em>Time Events</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getTimeEvents()
	 * @generated
	 * @ordered
	...
	public EList<ITimelineEvent> getTimeEvents() {
		if (timeEvents == null) {
			timeEvents = new EObjectContainmentWithInverseEList<>(ITimelineEvent.class, this, ITimelinePackage.LANE__TIME_EVENTS,
					ITimelinePackage.TIMELINE_EVENT__LANE);
		}
		return timeEvents;
	}
	...
	public ITimelineEvent createEvent(String title, String message, long startTimestamp, long duration) {
		return createEvent(title, message, startTimestamp, duration, TimeUnit.NANOSECONDS);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case ITimelinePackage.LANE___CREATE_EVENT__STRING_STRING_LONG_LONG_TIMEUNIT:
			return createEvent((String) arguments.get(0), (String) arguments.get(1), (Long) arguments.get(2), (Long) arguments.get(3),
					(TimeUnit) arguments.get(4));
		case ITimelinePackage.LANE___CREATE_EVENT__STRING_STRING_LONG_LONG:
			return createEvent((String) arguments.get(0), (String) arguments.get(1), (Long) arguments.get(2), (Long) arguments.get(3));
		}
