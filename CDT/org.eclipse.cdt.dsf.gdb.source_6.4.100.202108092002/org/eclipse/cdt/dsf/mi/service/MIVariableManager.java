...
public class MIVariableManager implements ICommandControl {
	...
	public class MIVariableObject {
		...
		protected List<String> p_vectorList = new ArrayList<String>(// CUSTOMIZATION
				Arrays.asList("v32int8x1_t *", "v16int16x1_t *", "v8int32x1_t *", "v32int8_t *", "v16int16_t *", "v8int32_t *", "v32int8x2_t *",
						"v16int16x2_t *", "v8int32x2_t *", "v32int8x4_t *", "v16int16x4_t *", "v8int32x4_t *", "v32uint8x1_t *", "v16uint16x1_t *",
						"v8uint32x1_t *", "v32uint8_t *", "v16uint16_t *", "v8uint32_t *", "v32uint8x2_t *", "v16uint16x2_t *", "v8uint32x2_t *",
						"v32uint8x4_t *", "v16uint16x4_t *", "v8uint32x4_t *", "v4int8_t *", "v2int16_t *", "v1int32_t *", "v8bool_t *",
						"v16bool_t *", "v32bool_t *"));
