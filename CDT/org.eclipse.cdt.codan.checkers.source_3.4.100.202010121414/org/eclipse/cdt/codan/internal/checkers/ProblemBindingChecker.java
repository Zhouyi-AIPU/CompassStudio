...
//							if (problemBinding.getID() == IProblemBinding.SEMANTIC_NAME_NOT_FOUND
//									&& CharArrayUtils.startsWith(problemBinding.getNameCharArray(), "__lsram0")) { //$NON-NLS-1$
//								return PROCESS_CONTINUE; // Ignore an unknown built-in.
//							}
//							if (problemBinding.getID() == IProblemBinding.SEMANTIC_NAME_NOT_FOUND
//									&& CharArrayUtils.startsWith(problemBinding.getNameCharArray(), "__lsram1")) { //$NON-NLS-1$
//								return PROCESS_CONTINUE; // Ignore an unknown built-in.
//							}
							// CUSTOMIZATION
							if (problemBinding.getID() == IProblemBinding.SEMANTIC_NAME_NOT_FOUND
