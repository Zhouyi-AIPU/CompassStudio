...
public class EventFigure extends RoundedRectangle implements Comparable<EventFigure> {
	...
	public EventFigure(ITimelineEvent event) {
		...
		fLabel.setForegroundColor(ColorConstants.white);
		add(fLabel);

		// final EList<ITimelineEvent> timeEvents = event.getLane().getTimeEvents();
		// System.out.println(timeEvents.size());
		// fLabel.addMouseListener(new MouseListener() {
		//
		// @Override
		// public void mouseDoubleClicked(MouseEvent arg0) {
		// // System.out.println(((Label) arg0.getSource()).getText());
		// }
		//
		// @Override
		...
		// // final EList<ITimelineEvent> timeEvents = event.getLane().getTimeEvents();
		// // for (final ITimelineEvent iTimelineEvent : timeEvents) {
		// // final String title = iTimelineEvent.getTitle();
		// // if (title.endsWith("test6")) {
		...
		// // }
		//
		// // final ITimelineEvent event2 = getEvent();
