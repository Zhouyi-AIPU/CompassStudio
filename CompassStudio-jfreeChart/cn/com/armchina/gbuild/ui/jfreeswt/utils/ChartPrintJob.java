...
public class ChartPrintJob {
	 ...
	 * Creates a new job.
	 * 
	 * @param jobName this will be the name of the print job or the default name of
	 *                the file (if printed to a file).
	 */
	 ...
	 * @param printer
	 * @param safetyBorder
	 * @return the rectangle in pixels to print on (and which is also supported by
