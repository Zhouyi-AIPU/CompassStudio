...
public class Keywords {
	...
	// CUSTOMIZATION
	public static final char[] c_entry = "__entry".toCharArray();
	// CUSTOMIZATION FOR OPENCL
	public static final char[] ckernel = "kernel".toCharArray();
	public static final char[] c_kernel = "__kernel".toCharArray();
	public static final char[] c_lsram = "__lsram".toCharArray();
	public static final char[] clocal = "local".toCharArray();
	public static final char[] c_local = "__local".toCharArray();
	public static final char[] cglobal = "global".toCharArray();
	public static final char[] c_global = "__global".toCharArray();
	public static final char[] cconstant = "constant".toCharArray();
	public static final char[] c_constant = "__constant".toCharArray();
	public static final char[] clsram0 = "lsram0".toCharArray();
	public static final char[] c_lsram0 = "__lsram0".toCharArray();
	public static final char[] clsram1 = "lsram1".toCharArray();
	public static final char[] c_lsram1 = "__lsram1".toCharArray();
	public static final char[] cgsram0 = "gsram0".toCharArray();
	public static final char[] c_gsram0 = "__gsram0".toCharArray();
	public static final char[] cgsram1 = "gsram1".toCharArray();
	public static final char[] c_gsram1 = "__gsram1".toCharArray();
	public static final char[] cprivate = "private".toCharArray();
	public static final char[] c_private = "__private".toCharArray();
	public static final char[] cuCHAR = "uchar".toCharArray();
	public static final char[] c_half = "half".toCharArray();
	public static final char[] c_event_t = "event_t".toCharArray();
