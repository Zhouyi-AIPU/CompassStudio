...
public interface IBasicType extends IType {
	...
	enum Kind {
		...
		eDecimal64,
		/** @since 5.10  */
		eDecimal128, eHalf, eEvent_t;// CUSTOMIZATION FOR OPENCL
	}
	...
	public static final int t_half = IASTSimpleDeclSpecifier.t_half;
	public static final int t_event_t = IASTSimpleDeclSpecifier.t_event_t;
