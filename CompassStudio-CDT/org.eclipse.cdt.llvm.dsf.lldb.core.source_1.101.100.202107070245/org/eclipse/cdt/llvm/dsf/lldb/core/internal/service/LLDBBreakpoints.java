...
public class LLDBBreakpoints extends GDBBreakpoints_7_4 {
	...
	protected String formatLocation(Map<String, Object> attributes) {
		String formatLocation = super.formatLocation(attributes);
	...
	public String adjustDebuggerPath(String originalPath) {
		...
		String adjustDebuggerPath = super.adjustDebuggerPath(originalPath);
//		String[] split = adjustDebuggerPath.split(File.separator);
//		return split[split.length-1];
		return adjustDebuggerPath;
	}
}
