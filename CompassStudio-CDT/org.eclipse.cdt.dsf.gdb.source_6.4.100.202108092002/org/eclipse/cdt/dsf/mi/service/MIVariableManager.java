...
public class MIVariableManager implements ICommandControl {
	...
	public class MIVariableObject {
		...
		// Customized vector type
		protected List<String> vectorList = new ArrayList<String>(// CUSTOMIZATION
				Arrays.asList("v32int8x1_t", "v16int16x1_t", "v8int32x1_t", "v32int8_t", "v16int16_t", "v8int32_t",
						"v32int8x2_t", "v16int16x2_t", "v8int32x2_t",
						"v32int8x4_t", "v16int16x4_t", "v8int32x4_t",
						"v32uint8x1_t", "v16uint16x1_t", "v8uint32x1_t",
						"v32uint8_t", "v16uint16_t", "v8uint32_t",
						"v32uint8x2_t", "v16uint16x2_t", "v8uint32x2_t",
						"v32uint8x4_t", "v16uint16x4_t", "v8uint32x4_t",
						"v4int8_t", "v2int16_t", "v1int32_t",
						"v8bool_t", "v16bool_t", "v32bool_t",
						"char2", "char3", "char4", "char8", "char16", "char32", // CUSTOMIZATION FOR OPENCL
						"uchar2", "uchar3", "uchar4","uchar8","uchar16","uchar32",
		...
		protected List<String> p_vectorList = new ArrayList<String>(// CUSTOMIZATION
				Arrays.asList("v32int8x1_t *", "v16int16x1_t *", "v8int32x1_t *", "v32int8_t *", "v16int16_t *",
						"v8int32_t *", "v32int8x2_t *", "v16int16x2_t *", "v8int32x2_t *", "v32int8x4_t *",
						"v16int16x4_t *", "v8int32x4_t *", "v32uint8x1_t *", "v16uint16x1_t *", "v8uint32x1_t *",
						"v32uint8_t *", "v16uint16_t *", "v8uint32_t *", "v32uint8x2_t *", "v16uint16x2_t *",
						"v8uint32x2_t *", "v32uint8x4_t *", "v16uint16x4_t *", "v8uint32x4_t *", "v4int8_t *",
						"v2int16_t *", "v1int32_t *", "v8bool_t *", "v16bool_t *", "v32bool_t *", "char2 *", "char3 *",
						"char4 *", "char8 *", "char16 *", "char32 *",
						"uchar2 *", "uchar3 *", "uchar4 *", "uchar8 *", "uchar16 *", "uchar32 *", "short2 *",
						"short3 *", "short4 *",
						"short8 *", "short16 *", "ushort2 *", "ushort3 *", "ushort4 *", "ushort8 *", "ushort16 *",
						"int2 *", "int3 *",
						"int4 *", "int8 *", "int16 *", "uint2 *", "uint3 *", "uint4 *", "uint8 *", "uint16 *",
						"long2 *", "long3 *",
						"long4 *", "long8 *", "long16 *", "ulong2 *", "ulong3 *", "ulong4 *", "ulong8 *", "ulong16 *",
						"float2 *", "float3 *", "float4 *", "float8 *", "float16 *", "half2 *", "half3 *", "half4 *",
						"half8 *", "half16 *", "bool8 *",
						"bool16 *", "bool32 *"));
		 ...
		 * @param typeName
		 * @param num
		 *            If the corresponding MI variable is dynamic, the number of
		...
		public void setExpressionData(ExpressionInfo info, String typeName, int num, boolean hasMore) {
			...
			setType(typeName);
			// CUSTOMIZATION
			if (vectorList.contains(typeName) || p_vectorList.contains(typeName)) {// Don't display customized vector type as array
				fNumChildrenHint = 0;
			}else {
