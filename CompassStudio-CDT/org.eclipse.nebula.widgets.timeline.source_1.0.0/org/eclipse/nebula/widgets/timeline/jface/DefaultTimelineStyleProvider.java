...
public class DefaultTimelineStyleProvider implements ITimelineStyleProvider {
	...
	private static final Color[] LANE_COLORS = new Color[] { ColorConstants.lightBlue, ColorConstants.lightGreen, ColorConstants.red };

	private int fNextLaneColor = 0;
	...
	public String getTimeLabel(double timestamp, TimeUnit unit) {
		...
		case MICROSECONDS:
			...
			// if (timestamp >= 10000) {
			// return String.format("%.0f", timestamp / 10000);
			// }
			return String.format("%.0f", timestamp);
		case MILLISECONDS:
			// if (timestamp >= 1000)
			...
			// if (timestamp >= 100000) {
			// return String.format("%.0f", timestamp / 100000);
			// }
			return String.format("%.0f", timestamp);
		case SECONDS:
			// if (timestamp >= 60)
			...
			// return String.format("%.0f", timestamp / 1000000);
			// }
			return String.format("%.0f", timestamp);
		case MINUTES:
			// if (timestamp >= 60)
			...
			// return String.format("%.0f", timestamp / 10000000);
			// }
			return String.format("%.0f", timestamp);
		case HOURS:
			// if (timestamp >= 10000000) {
		...
		case DAYS:
			...
			// return String.format("%.0f", timestamp / 100000000);
			// }
			return String.format("%.0f", timestamp);
